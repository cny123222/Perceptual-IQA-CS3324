#!/usr/bin/env python3
"""
重新生成Loss对比图 - 使用LaTeX渲染确保Times字体
"""
...
# 使用LaTeX渲染以确保Times字体
plt.rcParams['text.usetex'] = False  # 先不用LaTeX，使用serif
...
# 添加最佳标注
ax1.text(0, 0.9495, r'$\checkmark$ Best', ha='center', fontsize=10, weight='bold',
        color='#2E7D32',
...
ax2.set_xticklabels(loss_functions, fontsize=10)
...
# 添加最佳标注
ax2.text(0, 0.9505, r'$\checkmark$ Best', ha='center', fontsize=10, weight='bold',
        color='#2E7D32',
        bbox=dict(boxstyle='round,pad=0.4', facecolor='#A5D6A7', alpha=0.7))
...
ax3.set_xlabel('SRCC', fontsize=13, weight='bold')
...
print("✓ Loss对比图已生成（Times/Serif字体，无图例）")
print("  - paper_figures/loss_function_comparison.pdf")
print("  - paper_figures/loss_function_comparison.png")

...
if __name__ == '__main__':
    ...
    parser.add_argument('--no_color_jitter', dest='use_color_jitter', action='store_false', default=False, help='Disable ColorJitter augmentation (disabled by default for ResNet baseline to match original paper)')
    parser.add_argument('--use_color_jitter', dest='use_color_jitter', action='store_true', help='Enable ColorJitter augmentation (use this flag to enable)')

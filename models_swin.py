...
class SwinBackbone(nn.Module):
    ...
    def forward(self, x):
        ...
        # features[0]: Stage 1, 96 ch, 56x56
        # features[1]: Stage 2, 192 ch, 28x28
        # features[2]: Stage 3, 384 ch, 14x14
        # features[3]: Stage 4, 768 ch, 7x7
        ...
        out = {}
        out['hyper_in_feat'] = features[3]  # Use final stage features for hyper network

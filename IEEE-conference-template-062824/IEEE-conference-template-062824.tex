...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{../paper_figures/main_training_curves_final.pdf}
\caption{Training curves of the best model (Swin-Base, LR=$5\times10^{-7}$). Left: Training and validation loss. Middle: Validation SRCC with best performance at Epoch 7 (0.9378). Right: Validation PLCC (0.9485). The model shows stable convergence with early stopping triggered at Epoch 10.}
